...
public class BitManipulationHelperTest {
  ...
  @Test
  public void testDoublesToLongs() {
  ...
  @Test
  public void testIntegersToBytes() {
    ArrayList<Integer> originalIntegers = new ArrayList<>(numberOfIntegers);
  ...
  public void testLongsToBytes() {
    ArrayList<Long> originalLongs = new ArrayList<>(numberOfLongs);
  ...
  public void testShortsToBytes() {
    ArrayList<Short> originalShorts = new ArrayList<>(numberOfShorts);
